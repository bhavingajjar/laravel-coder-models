...
|--------|------|------|--------|
| `raw` | `raw/laravel_training.jsonl` | 1253 | `instruction`, `input`, `output`, `topic`, `version` |
| `chat` | `chat/laravel_training_chat.jsonl` | 1253 | `messages`, `topic`, `version` |
| `lora_train` | `lora/laravel_train.jsonl` | 150 | `messages`, `topic`, `version` |
| `lora_eval` | `lora/laravel_eval.jsonl` | 20 | `messages`, `topic`, `version` |
